...
class CodePagePreview extends Component{
    render() {
        ...
        <div>          
                <a href='index.html'>
                        <div className='hover:bg-slate-100 transition-all duration-200 ease-linear shadow-lg m-[3%] w-auto h-auto bg-slate-50 flex rounded-3xl p-5 flex-col'>
                                <h1 className='ml-auto relative flex items-center justify-center text-right text-[4.5vh]  px-3 mt-2 mb-2 bg-slate-200 text-slate-700 shadow-lg rounded-2xl'>Computer Science</h1>
