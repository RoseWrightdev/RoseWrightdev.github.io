    ...
    render() {
        ...
        <div>          
                <a href='index.html'>
                        ...
                        <h1 className='ml-auto mt-0 relative flex items-center justify-center text-right text-[4.5vh]  px-3 mb-2 bg-slate-200 text-slate-700 shadow-lg rounded-2xl'>Art</h1>
