    ...
    render() {
        ...
        <div>          
                <a href='index.html'>
                        ...
                        <h1 className='Icon group-hover:bg-slate-200 Icon group-hover:text-rose-700 group-hover:rounded-3xl transition-all duration-200 ease-linear ml-auto mt-0 relative flex items-center justify-center text-right text-[4.5vw]  px-3 mb-2 bg-slate-200 text-slate-700 shadow-lg rounded-lg '>Art</h1>
