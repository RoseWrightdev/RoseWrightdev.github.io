...
class ArtPagePreview extends Component{
    render() {
        ...
        <div>          
                <a href='index.html'>
                        <div className='Icon1 group hover:bg-slate-100 transition-all duration-200 ease-linear hover:shadow-lg m-[3%] w-auto h-auto flex rounded-3xl p-[1vw] flex-col'>
