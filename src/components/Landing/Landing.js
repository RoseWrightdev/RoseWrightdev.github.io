    ...
    render() {
        return (
            <div className='ml-16  w-auto  overflow-x-hidden flex flex-col'>
                <div className='transition-all duration-200 ease-linear shadow-lg m-[3%] w-auto bg-slate-200 flex rounded-3xl p-[1vw] flex-row-reverse'>
                    <div className=''>
                        <div className='bg-slate-100 p-5 rounded-3xl shadow-lg'>
                            ...
                            <br/>
                            <a href='index.html' className=' bg-rose-50 p-[1vh] rounded-3xl border-2 border-rose-400 text-slate-700 whitespace-nowrap	text-[2vw]'>Full article</a>
