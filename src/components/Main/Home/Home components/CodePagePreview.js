        ...
        <div>          
            <Link to='/ArticleTemplate'>
                <div className='Icon1 group hover:bg-slate-100 transition-all duration-200 ease-linear mx-auto max-w-[70vw] m-[3%] w-auto h-auto flex rounded-3xl p-[1vw] flex-col'>
                    ...
                    <img alt='Red Waves by Rose Wright is an art piece defined by its wave like sin and cos function visualized with Three.js' src={redwavesbyRoseWright} className=' Icon1 group-hover:bg-rose-500 transition-all duration-200 ease-linear relative flex items-center justify-center w-auto h-auto max-h-[100vh] shadow-lg rounded-2xl p-1  mt-1 mb-1 mx-auto bg-slate-300'></img>
                </div>
            </Link>
        </div>
            )
