...
class Contact extends Component{
    render() {
        return (
            ...
            <div className='ml-16  w-auto  overflow-x-hidden flex flex-col min-h-[100vh] '>
                <div className='shadow-lg mx-auto max-w-[70vw] m-[3%] w-auto bg-slate-200 flex rounded-3xl p-3 flex-row-reverse '>
                    <div className='bg-slate-100 p-5 rounded-3xl shadow-lg '>
                        ...
                        <div className='flexQ-col flex p-[0vw]'>
                            <div className='flexQ-width-col  max-w-[70vw] '>
                            <h2 className=' text-[3vw] text-center text-rose-600'>Contact me with questions at RoseSophieWright@gmail.com </h2>
                                <br/>
                                <p className='text-[2.5vw]  indent-10'>If you're a hiring manager or a recruiter I recommend you tag your emails [BUSINESS] for faster replies. I'll get back to you 5-7 business days.</p>                            <div/>
                            </div>
                        </div>
                    </div>
                </div>
